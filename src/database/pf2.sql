...
--
-- Servidor: localhost
-- Tiempo de generación: 08-03-2024 a las 02:11:36
...
INSERT INTO `bodegas` (`codigo_bodega`, `ubicacion_bodega`, `nombre_bodega`) VALUES
(1, 'Sector 1', 'Bodega Uno'),
(2, 'Sector 2', 'Bodega 2');
...
INSERT INTO `detalle_ubicacion` (`codigo_detalleUbi`, `sector`, `ubicacion_especifica`, `fk_bodega`) VALUES
(1, 'Sector 1', 'Parte 1', 1),
(2, 'Sector 1', 'Parte 2', 1);
...
CREATE TABLE `elementos` (
  ...
  `disponibilidad_stock` int NOT NULL,
...
INSERT INTO `elementos` (`codigo_elemento`, `nombre_elemento`, `stock`, `tipo_elemento`, `fecha_vancimiento`, `fk_categoria`, `fk_tipoEmpaque`, `unidad_medida`, `fk_ubicacion`, `disponibilidad_stock`, `estado`) VALUES
(1, 'cemento', 10, 'Consumible', '2025-03-20', 1, 1, 'kg', 1, 10, 'activo');
...
--
ALTER TABLE `categoria_elemento`
  MODIFY `codigo_categoria` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `detalle_ubicacion`
  MODIFY `codigo_detalleUbi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `reservas`
--
ALTER TABLE `reservas`
  MODIFY `codigo_reserva` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tipo_empaque`
--
ALTER TABLE `tipo_empaque`
  MODIFY `Codigo_empaque` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
